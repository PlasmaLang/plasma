...
maybe_gen_struct(Core, CtorId, TagInfo, !PZ) :-
    ...
    ( if NumFields > 0 then
        ...
        pz_memo_string(StructNameId, StructName, !PZ),
        (
        ...
        pz_add_struct(StructId, pz_struct(StructNameId, StructFields),
            !PZ)
    else
        true
    ).
    ...
    ( MaybeCtorIds = yes(CtorIds),
        ...
        ( if NumWithArgs = 0 then
            ...
            some [!PTagMap] (
                ...
                foldl5(make_ctor_tag_info(NeedSecTags), Ctors,
...
make_ctor_tag_info(NeedSecTag, {CtorId, Ctor}, !PTag, !STag,
