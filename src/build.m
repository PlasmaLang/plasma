...
:- pred ensure_rules_file(plzbuild_options::in, maybe_error::out,
    io::di, io::uo) is det.

ensure_rules_file(Options, Result, !IO) :-
    Rebuild = Options ^ pzb_rebuild,
    Verbose = Options ^ pzb_verbose,
    ( Rebuild = yes,
        write_rules_file(Verbose, Result, !IO)
    ; Rebuild = no,
...
:- pred write_rules_file(bool::in, maybe_error::out, io::di, io::uo) is det.
...
ensure_directory(Options, Result, !IO) :-
    ...
    ; StatResult = error(_),
        ...
        ( MkdirResult = yes,
            write_rules_file(Options ^ pzb_verbose, Result, !IO)
        ; MkdirResult = no,
            Result = error(
