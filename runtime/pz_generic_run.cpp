...
#undef PZ_RUN_SHIFT
            ...
            case PZT_CALL: {
                ...
                context.ip = (uint8_t *)AlignUp((uintptr_t)context.ip,
                        WORDSIZE_BYTES);
